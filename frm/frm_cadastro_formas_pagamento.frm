...
Begin VB.Form frm_cadastro_formas_pagamento 
   ...
   Begin VB.Frame fme_campos 
      ...
      Begin VB.CheckBox chk_ativo 
         ...
         Width           =   780
      End
      Begin VB.TextBox txt_forma_pagamento 
         Height          =   315
         Left            =   120
         TabIndex        =   10
         Top             =   480
   ...
   End
End
Attribute VB_Name = "frm_cadastro_formas_pagamento"
...
Private Enum enm_forma_pagamento
    col_forma_pagamento = 0
End Enum
...
erro_cmd_atualizar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_atualizar_Click"
...
erro_cmd_cancelar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_cancelar_Click"
...
Private Sub cmd_editar_Click()
    ...
    If (lfct_verificar_selecao) Then
        ...
        txt_forma_pagamento.SetFocus
    End If
fim_cmd_editar_Click:
    Exit Sub
erro_cmd_editar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_editar_Click"
...
erro_cmd_excluir_click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_excluir_Click"
...
erro_cmd_fechar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_fechar_Click"
...
erro_cmd_inserir_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_inserir_Click"
...
Private Sub cmd_salvar_Click()
    ...
    End If
    Me.ValidateControls
    If (txt_forma_pagamento.Text = "") Then
        MsgBox "Atenção!" & vbCrLf & "O campo [forma de pagamento] não pode estar em branco.", vbOKOnly + vbInformation, pcst_nome_aplicacao
        txt_forma_pagamento.SetFocus
        GoTo fim_cmd_salvar_Click
    ElseIf (Len(txt_forma_pagamento.Text) < 2) Then
        MsgBox "Atenção!" & vbCrLf & "O campo [forma de pagamento] não pode conter menos de 02 (dois) caracteres.", vbOKOnly + vbInformation, pcst_nome_aplicacao
        txt_forma_pagamento.SetFocus
        txt_forma_pagamento.SelStart = 0
        txt_forma_pagamento.SelLength = Len(txt_forma_pagamento.Text)
        GoTo fim_cmd_salvar_Click
    End If
...
erro_cmd_salvar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "cmd_salvar_Click"
    GoTo fim_cmd_salvar_Click
End Sub
...
Erro_Form_Initialize:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "Form_Initialize"
...
Fim_Form_KeyPress:
    Exit Sub
Erro_Form_KeyPress:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "Form_KeyPress"
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyF1
            psub_exibir_ajuda Me, "html/cadastros_formas_pagamento.htm", 0
        Case vbKeyF2
            cmd_inserir_Click
        Case vbKeyF3
            cmd_editar_Click
...
Fim_Form_KeyUp:
    Exit Sub
Erro_Form_KeyUp:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "Form_KeyUp"
    GoTo Fim_Form_KeyUp
End Sub
...
fim_Form_Load:
    Exit Sub
erro_Form_Load:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "Form_Load"
    GoTo fim_Form_Load
End Sub
...
erro_lsub_alterar_estado_controles:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lsub_alterar_estado_controles"
...
erro_lsub_limpar_campos:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lsub_limpar_campos"
...
Private Function lfct_salvar_registro(ByVal pbln_novo As Boolean, Optional ByVal plng_codigo As Long = 0) As Boolean
    ...
    If (pbln_novo) Then
        ...
        lstr_sql = lstr_sql & " '" & pfct_tratar_texto_sql(txt_forma_pagamento.Text) & "', "
        lstr_sql = lstr_sql & " '" & pfct_tratar_texto_sql(txt_observacoes.Text) & "', "
        lstr_sql = lstr_sql & " '" & IIf(chk_ativo.Value = vbChecked, "S", "N") & "' "
        lstr_sql = lstr_sql & " ) "
    Else
        lstr_sql = ""
        lstr_sql = lstr_sql & " update [tb_formas_pagamento] set "
        lstr_sql = lstr_sql & " [str_descricao] = '" & pfct_tratar_texto_sql(txt_forma_pagamento.Text) & "', "
    ...
    If (Not pfct_executar_comando_sql(lobj_salvar, lstr_sql, "frm_cadastro_formas_pagamento", "lfct_salvar_registro")) Then
...
erro_lfct_salvar_registro:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lfct_salvar_registro"
    GoTo fim_lfct_salvar_registro
End Function
...
Private Function lfct_excluir_registro(ByVal plng_codigo As Long) As Boolean
    ...
    'monta o comando sql
    lstr_sql = "select * from [tb_movimentacao] where int_forma_pagamento = " & pfct_tratar_numero_sql(plng_codigo)
    'executa o comando sql e devolve o objeto
    If (Not pfct_executar_comando_sql(lobj_movimentacao, lstr_sql, "frm_cadastro_formas_pagamento", "lfct_excluir_registro")) Then
        MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
        GoTo fim_lfct_excluir_registro
    End If
    llng_registros = lobj_movimentacao.Count
    If (llng_registros > 0) Then
        MsgBox "Atenção!" & vbCrLf & "Não é possível excluir a forma de pagamento selecionada pois existem [" & CStr(llng_registros) & "] movimentações relacionadas.", vbOKOnly + vbInformation, pcst_nome_aplicacao
        GoTo fim_lfct_excluir_registro
    Else
        'monta o comando sql
        lstr_sql = "delete from [tb_formas_pagamento] where int_codigo = " & pfct_tratar_numero_sql(plng_codigo)
        'executa o comando sql e devolve o objeto
        If (Not pfct_executar_comando_sql(lobj_excluir, lstr_sql, "frm_cadastro_formas_pagamento", "lfct_excluir_registro")) Then
            MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
            GoTo fim_lfct_excluir_registro
        End If
    End If
...
erro_lfct_excluir_registro:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lfct_excluir_registro"
    GoTo fim_lfct_excluir_registro
End Function
...
erro_lfct_verificar_selecao:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lfct_verificar_selecao"
    GoTo fim_lfct_verificar_selecao
End Function
...
Private Sub lsub_preencher_grade()
    ...
    Dim llng_registros As Long
    'monta a grade de formas de pagamento
    With msf_grade
        .Clear
        .Rows = 2
        .Row = 0
        .Col = enm_forma_pagamento.col_forma_pagamento
        .ColWidth(enm_forma_pagamento.col_forma_pagamento) = 3150
        .Text = "Formas de Pagamento"
    End With
    'monta o comando sql
    lstr_sql = " select * from [tb_formas_pagamento] order by [str_descricao] asc "
    'executa o comando sql e devolve o objeto
    If (Not pfct_executar_comando_sql(lobj_formas_pagamento, lstr_sql, "frm_cadastro_formas_pagamento", "lsub_preencher_grade")) Then
        MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
    ...
    If (llng_registros > 0) Then
        ...
        For llng_contador = 1 To llng_registros
            ...
            msf_grade.Col = enm_forma_pagamento.col_forma_pagamento
            msf_grade.RowData(llng_contador) = lobj_formas_pagamento(llng_contador)("int_codigo")
            msf_grade.TextMatrix(llng_contador, enm_forma_pagamento.col_forma_pagamento) = lobj_formas_pagamento(llng_contador)("str_descricao")
        ...
        msf_grade.Row = 1
        stb_status.Panels(enm_status.pnl_mensagem).Text = "Total de Formas de Pagamento cadastradas: " & llng_registros
        lsub_preencher_campos
        msf_grade_Click
    Else
        stb_status.Panels(enm_status.pnl_mensagem).Text = "Não há formas de pagamento cadastradas"
        msf_grade.TextMatrix(1, enm_forma_pagamento.col_forma_pagamento) = "Não há formas de pagamento cadastradas"
    End If
...
erro_lsub_preencher_grade:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lsub_preencher_grade"
    GoTo fim_lsub_preencher_grade
End Sub
...
Private Sub lsub_preencher_campos()
    ...
    Dim llng_registros As Long
    'monta o comando sql
    lstr_sql = " select * from [tb_formas_pagamento] where [int_codigo] = " & pfct_tratar_numero_sql(msf_grade.RowData(msf_grade.Row))
    'executa o comando sql e devolve o objeto
    If (Not pfct_executar_comando_sql(lobj_campos, lstr_sql, "frm_cadastro_formas_pagamento", "lsub_preencher_campos")) Then
        MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
    ...
    If (llng_registros > 0) Then
        ...
        txt_forma_pagamento.Text = lobj_campos(1)("str_descricao")
...
erro_lsub_preencher_campos:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "lsub_preencher_campos"
    GoTo fim_lsub_preencher_campos
End Sub
...
erro_mnu_msf_grade_copiar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "mnu_msf_grade_copiar_Click"
...
Private Sub mnu_msf_grade_exportar_Click()
    ...
    pfct_exportar_conteudo_grade msf_grade, "formas_de_pagamento"
fim_mnu_msf_grade_exportar_Click:
    Exit Sub
erro_mnu_msf_grade_exportar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "mnu_msf_grade_exportar_Click"
...
erro_msf_grade_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "msf_grade_Click"
...
erro_msf_grade_EnterCell:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "msf_grade_EnterCell"
...
erro_msf_grade_LeaveCell:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "msf_grade_LeaveCell"
...
erro_msf_grade_MouseUp:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "msf_grade_MouseUp"
    GoTo fim_msf_grade_MouseUp
End Sub

Private Sub txt_forma_pagamento_GotFocus()
    On Error GoTo erro_txt_forma_pagamento_gotFocus
    psub_campo_got_focus txt_forma_pagamento
fim_txt_forma_pagamento_gotFocus:
    Exit Sub
erro_txt_forma_pagamento_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_forma_pagamento_GotFocus"
    GoTo fim_txt_forma_pagamento_gotFocus
End Sub

Private Sub txt_forma_pagamento_LostFocus()
    On Error GoTo erro_txt_forma_pagamento_LostFocus
    psub_campo_lost_focus txt_forma_pagamento
fim_txt_forma_pagamento_LostFocus:
    Exit Sub
erro_txt_forma_pagamento_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_forma_pagamento_LostFocus"
    GoTo fim_txt_forma_pagamento_LostFocus
End Sub

Private Sub txt_forma_pagamento_Validate(Cancel As Boolean)
    On Error GoTo erro_txt_forma_pagamento_validate
    psub_tratar_campo txt_forma_pagamento
fim_txt_forma_pagamento_validate:
    Exit Sub
erro_txt_forma_pagamento_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_forma_pagamento_validate"
    GoTo fim_txt_forma_pagamento_validate
End Sub
...
erro_txt_observacoes_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_observacoes_GotFocus"
...
erro_txt_observacoes_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_observacoes_LostFocus"
...
erro_txt_observacoes_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_cadastro_formas_pagamento", "txt_observacoes_validate"
