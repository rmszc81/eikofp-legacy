...
Begin VB.Form frm_lancar_contas_receber 
   ...
   Begin VB.Frame fme_multiplos_vencimentos 
      ...
      Top             =   840
      Width           =   4995
      Begin VB.CheckBox chk_antecipar_recebimento 
         Caption         =   "&Antecipar recebimento caso data calculada não seja dia útil"
         Height          =   315
         Left            =   180
         TabIndex        =   11
         Top             =   1080
   ...
   End
End
Attribute VB_Name = "frm_lancar_contas_receber"
...
Private Function lfct_verificar_campos() As Boolean
    ...
    If (chk_baixar_conta.Value = vbChecked) Then
        ...
        If (cbo_conta_baixa_imediata.ItemData(cbo_conta_baixa_imediata.ListIndex) = 0) Then
            MsgBox "Atenção!" & vbCrLf & "Selecione um item no campo [conta].", vbOKOnly + vbInformation, pcst_nome_aplicacao
...
Erro_lfct_verificar_campos:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "lfct_verificar_campos"
    GoTo Fim_lfct_verificar_campos
End Function
...
erro_lsub_ajustar_data:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "lsub_ajustar_data"
    GoTo fim_lsub_ajustar_data
End Sub

Private Function lfct_lancar_conta_receber() As Boolean
    On Error GoTo erro_lfct_lancar_conta_receber
    Dim lobj_lancar_conta_receber As Object
    ...
    If (chk_multiplos.Value = vbChecked) Then
        ...
        For llng_contador = 1 To llng_quantidade
            ...
            If (Not pfct_executar_comando_sql(lobj_lancar_conta_receber, lstr_sql, "frm_lancar_contas_receber", "lfct_lancar_conta_receber")) Then
                MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
                GoTo fim_lfct_lancar_conta_receber
            End If
            ...
            End Select
            'antecipar pagamento
            If (chk_antecipar_recebimento.Value = vbChecked) Then
    ...
    Else
        ...
        End If
    End If
    lfct_lancar_conta_receber = True
fim_lfct_lancar_conta_receber:
    'destrói os objetos
    Set lobj_lancar_conta_receber = Nothing
    Exit Function
erro_lfct_lancar_conta_receber:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "lfct_lancar_conta_receber"
    GoTo fim_lfct_lancar_conta_receber
End Function
...
Private Function lfct_lancar_conta_movimentacao() As Boolean
    ...
    If ((p_usuario.bln_lancamentos_duplicados) And (lstr_documento <> Empty)) Then 'só verificamos se houver também um número de documento
        ...
        'executa o comando sql e devolve o objeto
        If (Not pfct_executar_comando_sql(lobj_movimentacao, lstr_sql, "frm_lancar_contas_receber", "lfct_lancar_conta_movimentacao")) Then
            MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
    ...
    'executa o comando sql e devolve o objeto
    If (Not pfct_executar_comando_sql(lobj_conta, lstr_sql, "frm_lancar_contas_receber", "lfct_lancar_conta_movimentacao")) Then
        MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
        GoTo fim_lfct_lancar_conta_movimentacao
    End If
    ...
    If (llng_registros > 0) Then
        ...
        'executa o comando sql e devolve o objeto
        If (Not pfct_executar_comando_sql(lobj_atualizar_saldo_conta, lstr_sql, "frm_lancar_contas_receber", "lfct_lancar_conta_movimentacao")) Then
            MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
            GoTo fim_lfct_lancar_conta_movimentacao
        End If
        ...
        lstr_sql = lstr_sql & " ) "
        'executa o comando sql e devolve o objeto
        If (Not pfct_executar_comando_sql(lobj_baixar_conta_receber, lstr_sql, "frm_lancar_contas_receber", "lfct_lancar_conta_movimentacao")) Then
            MsgBox "Erro ao executar comando SQL.", vbOKOnly + vbCritical, pcst_nome_aplicacao
            GoTo fim_lfct_lancar_conta_movimentacao
        End If
    End If
...
erro_lfct_lancar_conta_movimentacao:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "lfct_lancar_conta_movimentacao"
    GoTo fim_lfct_lancar_conta_movimentacao
End Function
...
erro_cbo_conta_baixa_automatica_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_automatica_DropDown"
...
erro_cbo_conta_baixa_automatica_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_automatica_GotFocus"
...
erro_cbo_conta_baixa_automatica_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_automatica_LostFocus"
...
erro_cbo_conta_baixa_imediata_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_imediata_DropDown"
...
erro_cbo_conta_baixa_imediata_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_imediata_GotFocus"
...
erro_cbo_conta_baixa_imediata_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_conta_baixa_imediata_LostFocus"
...
erro_cbo_forma_pagamento_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_forma_pagamento_DropDown"
...
erro_cbo_forma_pagamento_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_forma_pagamento_GotFocus"
...
erro_cbo_forma_pagamento_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_forma_pagamento_LostFocus"
...
erro_cbo_tempo_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tempo_DropDown"
...
erro_cbo_tempo_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tempo_GotFocus"
...
erro_cbo_tempo_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tempo_LostFocus"
...
erro_cbo_tipo_receita_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tipo_receita_DropDown"
...
erro_cbo_tipo_receita_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tipo_receita_GotFocus"
...
erro_cbo_tipo_receita_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cbo_tipo_receita_LostFocus"
...
Erro_chk_baixa_automatica_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "chk_baixa_automatica_Click"
...
Private Sub chk_baixar_conta_Click()
    ...
    If (chk_baixar_conta.Value = vbChecked) Then
        ...
        End If
        frm_lancar_contas_receber.Height = 8415
    ...
    Else
        ...
        End If
        frm_lancar_contas_receber.Height = 7425
...
erro_chk_baixar_conta_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "chk_baixar_conta_Click"
...
Private Sub chk_multiplos_Click()
    ...
    Else
        ...
        chk_antecipar_recebimento.Value = vbUnchecked
        '
...
erro_chk_multiplos_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "chk_multiplos_Click"
...
erro_cmd_cancelar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cmd_cancelar_Click"
...
Private Sub cmd_lancar_Click()
    ...
    If (lfct_verificar_campos) Then
        ...
        If (lint_resposta = vbYes) Then
            If (frm_lancar_contas_receber.chk_baixar_conta.Value = vbChecked) Then
                If (lfct_lancar_conta_movimentacao) Then
                    MsgBox "Atenção!" & vbCrLf & "Lançamento de contas a receber e baixa imediata realizado com sucesso.", vbOKOnly + vbInformation, pcst_nome_aplicacao
                    Unload Me
                Else
                    GoTo fim_cmd_lancar_Click
                End If
            Else
                If (lfct_lancar_conta_receber) Then
                    MsgBox "Atenção!" & vbCrLf & "Lançamento de contas a receber realizado com sucesso.", vbOKOnly + vbInformation, pcst_nome_aplicacao
                    Unload Me
                Else
                    GoTo fim_cmd_lancar_Click
                End If
...
erro_cmd_lancar_Click:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "cmd_lancar_Click"
    GoTo fim_cmd_lancar_Click
End Sub
...
erro_dtp_vencimento_DropDown:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "dtp_vencimento_DropDown"
...
erro_dtp_vencimento_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "dtp_vencimento_GotFocus"
...
erro_dtp_vencimento_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "dtp_vencimento_LostFocus"
...
Erro_Form_Initialize:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "Form_Initialize"
...
Fim_Form_KeyPress:
    Exit Sub
Erro_Form_KeyPress:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "Form_KeyPress"
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyF1
            psub_exibir_ajuda Me, "html/financeiro_contas_receber_lancar.htm", 0
        Case vbKeyF2
            cmd_lancar_Click
        Case vbKeyF3
            cmd_cancelar_Click
...
Fim_Form_KeyUp:
    Exit Sub
Erro_Form_KeyUp:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "Form_KeyUp"
    GoTo Fim_Form_KeyUp
End Sub
...
fim_Form_Load:
    Exit Sub
erro_Form_Load:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "Form_Load"
    GoTo fim_Form_Load
End Sub
...
fim_Form_Unload:
    Exit Sub
erro_Form_Unload:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "Form_Unload"
...
erro_txt_descricao_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_descricao_GotFocus"
...
erro_txt_descricao_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_descricao_LostFocus"
...
erro_txt_descricao_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_descricao_validate"
...
erro_txt_documento_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_documento_GotFocus"
...
erro_txt_documento_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_documento_LostFocus"
...
erro_txt_documento_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_documento_validate"
...
erro_txt_observacoes_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_observacoes_GotFocus"
...
erro_txt_observacoes_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_observacoes_LostFocus"
...
erro_txt_observacoes_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_observacoes_validate"
...
erro_txt_quantidade_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_quantidade_GotFocus"
...
erro_txt_quantidade_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_quantidade_LostFocus"
...
erro_txt_quantidade_Validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_quantidade_validate"
...
erro_txt_tempo_gotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_tempo_GotFocus"
...
erro_txt_tempo_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_tempo_LostFocus"
...
erro_txt_tempo_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_tempo_validate"
...
erro_txt_valor_GotFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_valor_GotFocus"
...
erro_txt_valor_LostFocus:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_valor_LostFocus"
...
erro_txt_valor_validate:
    psub_gerar_log_erro Err.Number, Err.Description, "frm_lancar_contas_receber", "txt_valor_validate"
